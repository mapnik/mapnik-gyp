...
SET POSTGIS_DL_URL=http://download.osgeo.org/postgis/windows/pg94/archive/postgis-bundle-pg94-2.2.1x64.zip
SET POSTGIS_ZIP_FOLDER=postgis-bundle-pg94-2.2.1x64
